...
- **飞鱼自主飞行** — SVG 飞鱼自由游动：正弦波漫游 → 鼠标吸引追逐 → 点击惊吓逃跑。瞳孔追踪光标，惯性系统带来自然的弧线迂回。
...
- 全站纯色背景（白天浅蓝 / 夜间深蓝），日夜切换整体色调
- 光粒子上升（55 个发光粒子，移动端 27）
- 星空 Canvas（200 自由粒子 + 12 星座星图 + 偶发流星）
- 三层云朵 CSS 漂移 + JS 鼠标视差
