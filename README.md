...
| **名字** | `index.html:78` — `<h1 class="name">孤鱼GY</h1>` |
| **简介** | `index.html:81` — `<p class="intro">在像素与星空间…</p>` |
| **GitHub 链接** | `index.html:86` — `#github-btn` 的 `href` |
| **Bilibili 链接** | `index.html:97` — `#bilibili-btn` 的 `href` |
| **邮箱** | `js/main.js:649` — `var email = 'guyu.email@qq.com'` |
| **浏览器图标** | 替换 `assets/favicon.svg`（保持同名） |
| **页面标题** | `index.html:6` — `<title>孤鱼GY · 天空之隙</title>` |
| **色调** | `css/style.css:7-19` — `:root` 中的 CSS 变量 |
